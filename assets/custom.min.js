!function(t) {
    ...
    function e() {
        ...
        null != e && e.length > 1 ? (e = e.split(","),
        t(".compareCount").text(e.length),
        t(".no-compare").hide(),
        t.each(e, function(e, a) {
            t(".compare[data-pid='" + a + "']").addClass("added").find("span").html(theme.compare.view)
        }),
    ...
    function n() {
        ...
        if (a.length)
            for (var i = 0; i < a.length; i++) {
                ...
                if (n.hasClass("fullw"))
                    c = '<div style="width:100%;"><div class="ratio" style="--bs-aspect-ratio: ' + 100 * s + '%">' + n[0].outerHTML + "</div></div>";
                else
                    var c = '<div style="width:100%;max-width:' + o + 'px"><div class="ratio" style="--bs-aspect-ratio: ' + 100 * s + '%">' + n[0].outerHTML + "</div></div>";
                n.after(c).remove()
            }
    }
    if (KT.ajaxSearch = function() {
        function e(e) {
            ...
            if (theme.function.searchTypesDrop) {
                ...
                "" !== s.val() && void 0 !== s.val() && (i = "product_type:" + s.val(),
                "" !== n.find("input.search").val() && void 0 !== n.find("input.search").val() && (i = i + " AND " + n.find("input.search").val()))
            }
            if ("" == i.trim())
                return n.removeClass("loading loaded"),
        ...
        t(document).on("keyup", ".box-search input.search", function(a) {
            ...
            var i = t(this)
              , n = t(this).val();
            if ("" === n || i.parents(".box-search.show").find(".li--s li").length > 0)
                return !1;
            t(".searchTypes").val(n),
            e(i)
        }).on("click", function(e) {
    ...
    KT.loadMiniCompare = function() {
        ...
        if (null != e && e.length > 1) {
            ...
            var a = '<ul class="compare-products list-unstyled"></ul><div class="compare-actions">' + `<button class="btn btn-primary btn-block btn-rounded" data-bs-toggle="offcanvas" data-bs-target="#compareOffcanvas" aria-controls="compareOffcanvas">${theme.compare.mini_title}</button>` + `<button class="compare-remove-all btn btn-link btn-underline sm ms-4">${theme.compare.clear_all}</button>` + "</div>";
            ...
            t.getJSON(Shopify.root_url + "/search/suggest.json", {
                ...
                t.each(a, function(t, e) {
                    i += `<li class="compare-product cp-${e.id}">` + `<button class="compare-remove btn-remove btn-close _p-0" data-pid="${e.id}" title="${theme.strings.remove}"></button>` + `<h4 class="compare-product-title"><a href="${e.url}">${e.title}</a></h4>` + "</li>"
                }),
    ...
    t(document).on("show.bs.offcanvas", "#cartOffcanvas", function() {
        ...
        theme.function.ajax_cart && (t(".content__cart-offcanvas").addClass("loading"),
        Shopify.KT_getCart())),
        KT.drawResize()
    }),
        ...
        var a = ""
          ...
          , f = function(t, e) {
            ...
            if ("" !== i.p) {
                ...
                void 0 == i.elp ? (n += void 0 !== c[e] ? "padding:" + c[e] + ";" : "") === i.el + "{" ? n = "" : n += "}" : void 0 !== c[e] ? (n === i.el + "{" ? n = "" : n += "}",
                n += i.elp + "{",
                n += void 0 !== c[e] ? "padding:" + c[e] + ";" : "",
                n += "}") : n === i.el + "{" ? n = "" : n += "}"
            } else
                n === i.el + "{" ? n = "" : n += "}";
            return n
          ...
          , v = {
            match: function() {
                void 0 !== e ? a += f(e, 0) : t.each(m, function(e, i) {
                    a += f(t(this), 0)
                }),
                a = "" !== a ? "@media " + r + "{" + a + "}" : ""
            },
          ...
          , g = {
            match: function() {
                void 0 !== e ? i += f(e, 1) : t.each(m, function(e, a) {
                    i += f(t(this), 1)
                }),
                i = "" !== i ? "@media " + l + "{" + i + "}" : ""
            },
          ...
          , w = {
            match: function() {
                void 0 !== e ? n += f(e, 2) : t.each(m, function(e, a) {
                    n += f(t(this), 2)
                }),
                n = "" !== n ? "@media " + d + "{" + n + "}" : ""
            },
          ...
          , k = {
            match: function() {
                void 0 !== e ? o += f(e, 3) : t.each(m, function(e, a) {
                    o += f(t(this), 3)
                }),
                o = "" !== o ? "@media " + u + "{" + o + "}" : ""
            },
          ...
          , b = {
            match: function() {
                void 0 !== e ? s += f(e, 4) : t.each(m, function(e, a) {
                    s += f(t(this), 4)
                }),
                s = "" !== s ? "@media " + h + "{" + s + "}" : ""
            },
          ...
          , y = {
            match: function() {
                void 0 !== e ? c += f(e, 5) : t.each(m, function(e, a) {
                    c += f(t(this), 5)
                }),
                c = "" !== c ? "@media " + p + "{" + c + "}" : ""
            },
    ...
    t(document).ready(function() {
        ...
        function() {
            ...
            t(document).on("click", ".quick-view", function(a) {
                ...
                if (o = void 0 !== o ? "?variant=" + o + "&" : "?",
                i.addClass("loading"),
                e.attr("data-view") == n)
                    return i.removeClass("loading"),
                    e.modal("show"),
                    !1;
                ...
                t.ajax({
                    ...
                    success: function(a) {
                        ...
                        console.log(a)
                        console.log(o)
                        // var s = o[2].split("\x3c!-- noscript --\x3e")[1].replace(/(noscript)/gm, "script")
                        // t(".product-quickview-content").html(o[2].split("\x3c!-- noscript --\x3e")[0]),
                        t(".product-quickview-content").append(a),
                        t("body").append('<div id="Product_Attr">' + a + "</div>"),
        ...
        function() {
            ...
            t(document).on("click", ".kt__quick-shop", function(a) {
                ...
                if (t("#qs-" + i.pid).length > 0)
                    return t(".modalQuickShop .modal-content").attr("data-pid", i.pid).html(t("#qs-" + i.pid)[0].innerText),
                    e.modal("show"),
                    !1;
                ...
                t.ajax({
                    ...
                    type: "GET",
                    success: function(a) {
                        t(".modalQuickShop .modal-content").attr("data-pid", i.pid).html(a),
                        e.modal("show"),
        ...
        t(document).on("click", ".kt__edit-opts", function(e) {
            ...
            if (t("#eo-" + a.pid).length > 0)
                return t("#editOptsOffcanvas .offcanvas-body").attr("data-pid", a.pid).html(t("#eo-" + a.pid)[0].innerText),
                !1;
            ...
            t.ajax({
                ...
                success: function(e) {
                    ...
                    void 0 !== a.qty && (t("#editOptsOffcanvas").find("#qty-eo").val(a.qty),
                    t("#editOptsOffcanvas").find('[name="updates[' + a.vrid + ']"]').val(a.qty),
        ...
        t(document).on("variantChange", "#editOptsOffcanvas form", function(e) {
            ...
            t("#editOptsOffcanvas form").append('<input class="it-ip-editing" type="hidden" name="updates[' + t("#qty-eo").attr("data-id") + ']" value="' + t("#qty-eo").val() + '">')) : t(".it-ip-editing").attr({
        ...
        t(document).on("hidden.bs.offcanvas", "#editOptsOffcanvas", function() {
            t("#eo-" + t("#editOptsOffcanvas .offcanvas-body").attr("data-pid")).length <= 0 && t("body").append('<noscript id="eo-' + t("#editOptsOffcanvas .offcanvas-body").attr("data-pid") + '">' + t("#editOptsOffcanvas .offcanvas-body").html() + "</noscript>"),
            t("#editOptsOffcanvas .offcanvas-body").html("")
        }),
        t(document).on("variantsLoaded", "#editOptsOffcanvas form", function(e) {
            e.variant,
            t("#editOptsOffcanvas").find(" ul._small").removeClass("_small").addClass("_huge")
        }),
        n(),
        a(),
        KT.respSpaceSc(),
        ...
        t("body").on("click", ".compare", function(a) {
            ...
            t(this).hasClass("added"))
                return t("#compareOffcanvas").offcanvas("show"),
                !1;
            var i = t(this)
              , n = i.attr("data-pid")
              , o = localStorage.getItem("kt-compare");
            i.addClass("loading"),
            (o = null !== o && o.length > 1 ? o.split(",") : new Array).indexOf(n) < 0 && !1 === t(this).hasClass("added") && (o.push(n),
        ...
        t(document).on("click", ".compare-remove", function(e) {
            ...
            t('.compare[data-pid="' + a + '"]').removeClass("added").find("span").html(theme.compare.add);
        ...
        theme.suggest.enable && function() {
            function e() {
                if (0 != i.length) {
                    ...
                    s.find(".title-sg").html(a.title).attr({
            ...
            var a, i = sessionStorage.getItem("sggPrds"), n = 0, o = theme.suggest.delay_time, s = (theme.suggest.show_time,
            t("#suggestToast"));
            if (s.length <= 0)
                return !1;
            const c = document.getElementById("suggestToast")
              , r = new bootstrap.Toast(c);
            if (a = setInterval(function() {
                r.show()
            }, o),
            ...
            null !== i) {
                if (0 == (i = jQuery.parseJSON(i)).length)
                    return;
                e(),
                setTimeout(function() {
                    r.show()
        ...
        t(document).on("click", ".widget-cats .level-has-child>a i", function(e) {
            e.preventDefault(),
            t(this).parents(".level-has-child").first().find(".child_link").first().slideToggle()
        }),
        t(document).on("click", ".mini-cart:not(.cart-none) .icon-link", function(t) {
            t.preventDefault()
        ...
        t(".ajax__list-cart").length && theme.function.ajax_cart && "drop" === theme.function.type_ajax_cart && t(document).on("mouseenter", ".mini-cart:not([onclick]) .icon-link", function(e) {
            t(".mini-cart").hasClass("load") && (t(".mini-cart").removeClass("load"),
        ...
        t(document).on("click", ".footer__cart-offcanvas .nav-link", function() {
        ...
        t(document).on("show.bs.tab", '.tab-list-ajax button[data-bs-toggle="tab"]', function(e) {
            ...
            if (t(t(this).attr("data-bs-target")).find(".swiper-wrapper.lazyload").length > 0) {
                ...
                t(t(this).attr("data-bs-target")).find(".button-loadmore").css("opacity", "0")
            }
        }),
        ...
        t("#product-tabs").length > 0 && t(document).on("click", ".rating-reviews.sg", function(e) {
            e.preventDefault(),
            t("#product-tabs .tb_review").trigger("click"),
            document.querySelector(t("#product-tabs .tb_review").attr("data-bs-target")).scrollIntoView({
                behavior: "smooth"
            })
        }),
        t("#product-accordion").length > 0 && t(document).on("click", ".rating-reviews.sg", function(e) {
            e.preventDefault(),
            t("#product-accordion .tb_review").trigger("click"),
            document.querySelector(t("#product-accordion .tb_review").attr("data-bs-target")).scrollIntoView({
                behavior: "smooth"
            })
        }),
